...
-- total revenue genrated by male vs. female customers
...
--which are the top5 products with the highest average rating review
...
--purchases, show count of each segment
...
--top 3 most purchase product within each category
with item_counts as(
...
--what is revenue contribution by each age group
